        ...
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
          <div className="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
            ...
            <div className="flex mb-4">
              <a href="true" className={`flex-grow text-${props.theme}-500 border-b-2 border-${props.theme}-500 py-2 text-lg px-1`}>
                Description
              </a>
              <a href="true" className="flex-grow border-b-2 border-gray-300 py-2 text-lg px-1">
                Reviews
              </a>
              <a href="true" className="flex-grow border-b-2 border-gray-300 py-2 text-lg px-1">
                Details
